...
public interface JavaOOPSInterfaces {
...
/* Here in this interface, it will have only methods without body of execution
   When any class implements this interface then that class has to add all methods and put their code of execution in each method
   All the methods present in interface, are all come under 'Abstraction' OOPs concept
*/
